...
urlpatterns = [
    ...
    path('time-series', api_views.statistics_time_series, name='statistics-time-series'),
    path('time-series/', api_views.statistics_time_series, name='statistics-time-series-slash'),
